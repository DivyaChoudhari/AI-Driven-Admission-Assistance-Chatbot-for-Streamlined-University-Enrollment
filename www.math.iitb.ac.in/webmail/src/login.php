...
<link rel="shortcut icon" href="/www.math.iitb.ac.in/webmail/favicon.ico"><script type="text/javascript" language="JavaScript">
<!--
...
<title>MATHS, IIT BOMBAY - Login</title><script language="JavaScript" type="text/javascript">
<!--
...
<table bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" width="100%"><tbody><tr><td align="center"><center><img src="../images/sm_logo.png" alt="MATHS, IIT BOMBAY Logo" width="308" height="111"><br>
<small>SquirrelMail version 1.4.23 [SVN]-1.el8.20190710<br>
  By the SquirrelMail Project Team<br></small>
<table bgcolor="#ffffff" border="0" width="350"><tbody><tr><td bgcolor="#dcdcdc" align="center"><b>MATHS, IIT BOMBAY Login</b>
</td>
</tr>
<tr><td bgcolor="#ffffff" align="left">
<table bgcolor="#ffffff" align="center" border="0" width="100%" id="login_table"><tbody><tr><td align="right" width="30%" id="username_td">Name:</td>
...
<table width="350">
<tbody><tr><td><center>
What is 14 - 2? <input type="text" autocomplete="off" name="captcha_response" value="" size="5">
</center></td></tr>
</tbody></table>
</center>
</form>
